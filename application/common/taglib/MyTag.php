...
php;
    ...
    // bootstrapcss标签
    public function tagBootstrapcss($tag,$content) {
        $link=<<<php
...
php;
    ...
    // bootstrapjs标签
    public function tagBootstrapjs($tag,$content) {
        $link=<<<php
<!-- 引入bootstrjs部分开始 -->
<script src="__PUBLIC__/statics/js/jquery-1.10.2.min.js"></script>
...
php;
    ...
    // bootstrapcss标签
    public function tagSuicss($tag,$content) {
        $link=<<<php
...
php;
    ...
    // bootstrapjs标签
    public function tagSuijs($tag,$content) {
        $link=<<<php
...
php;
    ...
    // framework7css标签
    public function tagFramework7css($tag,$content) {
        $link=<<<php
...
php;
    ...
    // framework7js标签
    public function tagFramework7js($tag,$content) {
        $link=<<<php
...
php;
    ...
    // frozenuicss标签
    public function tagFrozenuicss($tag,$content) {
        $link=<<<php
...
php;
    ...
    // frozenuijs标签
    public function tagFrozenuijs($tag,$content) {
        $link=<<<php
...
php;
    ...
    * 引入umeidter的css部分
    */
   public function tagUmeditorcss(){
        $link=<<<php
...
php;
    ...
    public function tagWebuploader($tag){
        $url=isset($tag['url'])?$tag['url']:url('Index/Index/ajax_upload');
